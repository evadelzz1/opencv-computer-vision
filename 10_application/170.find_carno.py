...
# Read Input Image
img_ori = cv2.imread('./data/CarNo1.png')
...
for i, plate_img in enumerate(plate_imgs):
    ...
    # Download : kor.traineddata file
    #            mv /opt/homebrew/share/tessdata/kor.traineddata /opt/homebrew/share/tessdata/kor.traineddata_bak
    #            mv ~/Downloads/kor.traineddata /opt/homebrew/share/tessdata/
...
# https://velog.io/@mactto3487/프로젝트-OpenCV-자동차-번호판-인식
